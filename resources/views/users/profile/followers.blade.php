                    ...
                    @foreach ($user->followers as $follower)
                        <div class="row align-items-center mt-3">
                            ...
                            <div class="col-auto">
                                ...
                                {{-- In user.php, we have following_id.  In follow.php $user->follower and then going to “the follower” . “the follower” meands specify the id of follower = follower->id
 --}}
